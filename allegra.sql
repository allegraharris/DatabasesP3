...
SELECT * FROM employees JOIN departments ON employees.dep_id = departments.dep_id where employees.dep_id < employees.emp_id and employees.emp_id != departments.dep_id;