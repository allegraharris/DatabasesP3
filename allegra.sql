...
INSERT INTO employees () VALUES (8227,'charlie mei',3), (2353,'allegra harris',2), (2370,'sarah green',4), (3746,'charlie mei',5), (1746, 'bebe green',5);
SELECT * from employees JOIN departments ON employees.dep_id = departments.dep_id WHERE employees.emp_id=employees.dep_id OR employees.emp_id>3000;
